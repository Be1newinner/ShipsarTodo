...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 space-y-8 p-8 bg-gradient-to-b from-background to-card/20">
      {/* Header */}
      <div className="space-y-2">
        <h1 className="text-4xl font-bold text-foreground">Welcome back, {user?.name?.split(' ')[0]}!</h1>
        <p className="text-muted-foreground">Here's what you need to accomplish today</p>
      </div>
